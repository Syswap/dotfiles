...
pacstrap /mnt linux linux-firmware linux-headers base base-devel git wget curl grub ntfs-3g os-prober dhcpcd dhclient wpa_supplicant dialog networkmanager network-manager-applet

echo "Graphics drivers"

echo "AMD"
pacstrap /mnt lib32-mesa vulkan-radeon lib32-vulkan-radeon vulkan-icd-loader lib32-vulkan-icd-loader
...
echo fluttershy > /etc/hostname
echo '127.0.0.1 fluttershy.localdomain fluttershy' >> /etc/hosts
