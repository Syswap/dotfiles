...
echo "Intel"
pacstrap /mnt mesa lib32-mesa vulkan-intel lib32-vulkan-intel vulkan-icd-loader lib32-vulkan-icd-loader

echo "nVidia"
pacstrap /mnt nvidia-dkms nvidia-utils lib32-nvidia-utils nvidia-settings 
